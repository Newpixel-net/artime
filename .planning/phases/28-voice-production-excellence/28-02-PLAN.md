...
Match existing styling patterns (rgba colors, font-sizes, margin/padding).
  ...
  <verify>
Run: `grep -n "wire:click.*previewVoiceWithEmotion" modules/AppVideoWizard/resources/views/livewire/modals/character-bible.blade.php`
Should return line number showing the wire:click attribute exists.

Run: `grep -c "previewEmotion" modules/AppVideoWizard/resources/views/livewire/modals/character-bible.blade.php`
Should return 2 or more (wire:model and label).

Run: `grep -n "Emotion Preview" modules/AppVideoWizard/resources/views/livewire/modals/character-bible.blade.php`
Should return line number showing the section exists.
  </verify>
...
1. Run: `grep -c "previewVoiceWithEmotion" modules/AppVideoWizard/app/Livewire/VideoWizard.php` - should return 1 or more
2. Run: `grep "wire:click.*previewVoiceWithEmotion" modules/AppVideoWizard/resources/views/livewire/modals/character-bible.blade.php` - should show the button binding
3. Run: `php artisan tinker --execute="(new ReflectionMethod(\Modules\AppVideoWizard\Livewire\VideoWizard::class, 'previewVoiceWithEmotion'))->getNumberOfParameters()"` - should return 2
</verification>
