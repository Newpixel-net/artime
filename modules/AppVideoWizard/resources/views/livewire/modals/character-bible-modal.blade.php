    ...
    <div class="vw-modal"
        ...
        <div style="padding: 0.5rem 1rem; border-bottom: 1px solid rgba(255,255,255,0.1); display: flex; justify-content: space-between; align-items: center; flex-shrink: 0;">
            ...
            <div style="display: flex; align-items: center; gap: 0.5rem;">
                @if(!empty($storyBibleCharacters) && $storyBibleStatus === 'ready')
                    <button type="button"
                            wire:click="syncFromStoryBible"
                        ...
                        <span style="background: rgba(255,255,255,0.2); padding: 0.1rem 0.3rem; border-radius: 0.25rem; font-size: 0.55rem;">{{ count($storyBibleCharacters) }}</span>
                    </button>
                @endif
                <button type="button" wire:click="closeModal" style="background: none; border: none; color: white; font-size: 1.25rem; cursor: pointer; padding: 0.25rem; line-height: 1;">&times;</button>
            </div>
        </div>
        ...
        @elseif(!empty($storyBibleCharacters) && $storyBibleStatus === 'ready')
            <div style="padding: 0.35rem 1rem; background: rgba(16,185,129,0.1); border-bottom: 1px solid rgba(16,185,129,0.2); color: #6ee7b7; font-size: 0.65rem; display: flex; align-items: center; gap: 0.5rem;">
                ...
                {{ __('Synced') }} {{ count($storyBibleCharacters) }} {{ __('characters from Story Bible') }}
            </div>
        @endif
        ...
        <div style="flex: 1; overflow-y: auto; padding: 0.75rem; display: flex; gap: 0.75rem;">
            ...
            <div style="width: 190px; flex-shrink: 0; border-right: 1px solid rgba(255,255,255,0.1); padding-right: 0.75rem;">
                ...
                @php
                    $charactersNeedingPortraits = collect($characterBible['characters'] ?? [])->filter(function($char) {
                        return empty($char['referenceImageBase64']) && empty($char['referenceImage']) || ($char['referenceImageStatus'] ?? '') !== 'ready';
                    })->count();
                @endphp
                ...
                <div style="display: flex; flex-direction: column; gap: 0.35rem; max-height: 380px; overflow-y: auto;">
                    @forelse($characterBible['characters'] ?? [] as $index => $character)
                    ...
                    <div style="display: flex; gap: 0.75rem;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="margin-bottom: 0.4rem;">
                                ...
                                <input type="text"
                                       wire:model.blur="characterBible.characters.{{ $editIndex }}.name"
                            ...
                            <div style="margin-bottom: 0.4rem;">
                                ...
                                <div style="display: flex; gap: 0.25rem; flex-wrap: wrap;">
                                    ...
                                    <button type="button" wire:click="applyCharacterTemplate({{ $editIndex }}, 'mysterious')" style="padding: 0.2rem 0.4rem; background: rgba(139,92,246,0.15); border: 1px solid rgba(139,92,246,0.3); border-radius: 0.2rem; color: #c4b5fd; font-size: 0.55rem; cursor: pointer;">{{ __('Mysterious') }}</button>
                                    <button type="button" wire:click="applyCharacterTemplate({{ $editIndex }}, 'narrator')" style="padding: 0.2rem 0.4rem; background: rgba(251,191,36,0.15); border: 1px solid rgba(251,191,36,0.3); border-radius: 0.2rem; color: #fcd34d; font-size: 0.55rem; cursor: pointer;">{{ __('Narrator') }}</button>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 0.4rem;">
                                ...
                                <textarea wire:model.blur="characterBible.characters.{{ $editIndex }}.description"
                            ...
                            <div x-data="{ traitsOpen: false, newTrait: '' }" style="margin-bottom: 0.4rem;">
                                <button type="button"
                                    ...
                                    <span style="color: rgba(255,255,255,0.6); font-size: 0.6rem; transition: transform 0.2s;" :style="traitsOpen ? '' : 'transform: rotate(-90deg)'">V</span>
                            ...
                            {{-- CHARACTER DNA - Consolidated Section --}}
                            @php
                            ...
                            <div x-data="{ dnaOpen: false, presetsOpen: false }" style="margin-bottom: 0.4rem; padding: 0.35rem; background: rgba(139,92,246,0.08); border: 1px solid rgba(139,92,246,0.2); border-radius: 0.35rem;">
                                ...
                                <button type="button"
                                    ...
                                    <span style="color: #c4b5fd; font-size: 0.6rem; transition: transform 0.2s;" :style="dnaOpen ? '' : 'transform: rotate(-90deg)'">V</span>
                                    ...
                                    @if($hasDNA)
                                        <span style="color: #10b981; font-size: 0.5rem; margin-left: auto;">OK {{ __('defined') }}</span>
                                    @endif
                                </button>
                                ...
                                <div x-show="dnaOpen" x-collapse style="margin-top: 0.35rem;">
                                    ...
                                    <div style="margin-bottom: 0.35rem;">
                                        <button type="button"
                                            ...
                                            <span style="color: rgba(255,255,255,0.5); font-size: 0.5rem; transition: transform 0.2s;" :style="presetsOpen ? '' : 'transform: rotate(-90deg)'">V</span>
                                        ...
                                        <div x-show="presetsOpen" x-collapse style="display: flex; flex-wrap: wrap; gap: 0.2rem;">
                                            ...
                                            <button type="button" wire:click="applyCharacterLookPreset({{ $editIndex }}, 'action-hero-female')" style="padding: 0.15rem 0.3rem; background: rgba(239,68,68,0.15); border: 1px solid rgba(239,68,68,0.3); border-radius: 0.2rem; color: #fca5a5; font-size: 0.45rem; cursor: pointer;">{{ __('Action F') }}</button>
                                            <button type="button" wire:click="applyCharacterLookPreset({{ $editIndex }}, 'action-hero-male')" style="padding: 0.15rem 0.3rem; background: rgba(239,68,68,0.15); border: 1px solid rgba(239,68,68,0.3); border-radius: 0.2rem; color: #fca5a5; font-size: 0.45rem; cursor: pointer;">{{ __('Action M') }}</button>
                                            ...
                                            <button type="button" wire:click="applyCharacterLookPreset({{ $editIndex }}, 'fantasy-warrior')" style="padding: 0.15rem 0.3rem; background: rgba(251,191,36,0.15); border: 1px solid rgba(251,191,36,0.3); border-radius: 0.2rem; color: #fcd34d; font-size: 0.45rem; cursor: pointer;">{{ __('Fantasy') }}</button>
                                        </div>
                                    </div>
                                    ...
                                    <div style="margin-bottom: 0.3rem; padding: 0.25rem; background: rgba(255,255,255,0.03); border-radius: 0.25rem;">
                                        <div style="display: flex; align-items: center; gap: 0.3rem; margin-bottom: 0.2rem;">
                                            ...
                                            @if(!empty($currentChar['hair']['style'] ?? '') || !empty($currentChar['hair']['color'] ?? ''))
                                                <span style="color: #10b981; font-size: 0.45rem;">OK</span>
                                            @endif
                                        </div>
                                        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 0.2rem;">
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.hair.color"
                                            ...
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.hair.style"
                                                   placeholder="{{ __('Style') }}"
                                                   style="width: 100%; padding: 0.2rem 0.3rem; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 0.2rem; color: white; font-size: 0.55rem;">
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.hair.length"
                                                   placeholder="{{ __('Length') }}"
                                                   style="width: 100%; padding: 0.2rem 0.3rem; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 0.2rem; color: white; font-size: 0.55rem;">
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.hair.texture"
                                    ...
                                    <div style="margin-bottom: 0.3rem; padding: 0.25rem; background: rgba(255,255,255,0.03); border-radius: 0.25rem;">
                                        ...
                                        <textarea wire:model.blur="characterBible.characters.{{ $editIndex }}.wardrobe.outfit"
                                        ...
                                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.2rem;">
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.wardrobe.colors"
                                                   placeholder="{{ __('Colors') }}"
                                                   style="width: 100%; padding: 0.2rem 0.3rem; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 0.2rem; color: white; font-size: 0.55rem;">
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.wardrobe.style"
                                                   placeholder="{{ __('Style') }}"
                                                   style="width: 100%; padding: 0.2rem 0.3rem; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 0.2rem; color: white; font-size: 0.55rem;">
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.wardrobe.footwear"
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.25rem;">
                                        ...
                                        <div style="padding: 0.25rem; background: rgba(255,255,255,0.03); border-radius: 0.25rem;">
                                            ...
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.makeup.style"
                                            ...
                                            <input type="text" wire:model.blur="characterBible.characters.{{ $editIndex }}.makeup.details"
                            ...
                            <div x-data="{ voiceOpen: false }" style="margin-bottom: 0.4rem; padding: 0.35rem; background: rgba(16,185,129,0.08); border: 1px solid rgba(16,185,129,0.2); border-radius: 0.35rem;">
                                ...
                                <button type="button"
                                        ...
                                        style="display: flex; align-items: center; gap: 0.25rem; width: 100%; background: none; border: none; padding: 0; cursor: pointer;">
                                    <span style="color: #6ee7b7; font-size: 0.6rem; transition: transform 0.2s;" :style="voiceOpen ? '' : 'transform: rotate(-90deg)'">V</span>
                                    <span style="color: #6ee7b7; font-size: 0.65rem; font-weight: 600;">{{ __('Character Voice') }}</span>
                                    <span style="color: rgba(255,255,255,0.4); font-size: 0.5rem; margin-left: 0.2rem;">({{ __('TTS & Lip-sync') }})</span>
                                    @if($hasVoice)
                                        <span style="color: #10b981; font-size: 0.5rem; margin-left: auto;">OK {{ $voiceSettings['id'] ?? '' }}</span>
                                    @endif
                                ...
                                <div x-show="voiceOpen" x-collapse style="margin-top: 0.35rem;">
                                    ...
                                    <div style="margin-bottom: 0.35rem;">
                                        ...
                                        <div style="display: flex; flex-wrap: wrap; gap: 0.2rem;">
                                            <button type="button" wire:click="applyCharacterVoicePreset({{ $editIndex }}, 'hero-male')" style="padding: 0.15rem 0.3rem; background: rgba(6,182,212,0.15); border: 1px solid rgba(6,182,212,0.3); border-radius: 0.2rem; color: #67e8f9; font-size: 0.45rem; cursor: pointer;">{{ __('Hero M') }}</button>
                                            <button type="button" wire:click="applyCharacterVoicePreset({{ $editIndex }}, 'hero-female')" style="padding: 0.15rem 0.3rem; background: rgba(236,72,153,0.15); border: 1px solid rgba(236,72,153,0.3); border-radius: 0.2rem; color: #f9a8d4; font-size: 0.45rem; cursor: pointer;">{{ __('Hero F') }}</button>
                                            <button type="button" wire:click="applyCharacterVoicePreset({{ $editIndex }}, 'villain-male')" style="padding: 0.15rem 0.3rem; background: rgba(139,92,246,0.15); border: 1px solid rgba(139,92,246,0.3); border-radius: 0.2rem; color: #c4b5fd; font-size: 0.45rem; cursor: pointer;">{{ __('Villain M') }}</button>
                                            <button type="button" wire:click="applyCharacterVoicePreset({{ $editIndex }}, 'villain-female')" style="padding: 0.15rem 0.3rem; background: rgba(139,92,246,0.15); border: 1px solid rgba(139,92,246,0.3); border-radius: 0.2rem; color: #c4b5fd; font-size: 0.45rem; cursor: pointer;">{{ __('Villain F') }}</button>
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.3rem; margin-bottom: 0.3rem;">
                                        ...
                                        <div>
                                            ...
                                            <select wire:model.live="characterBible.characters.{{ $editIndex }}.voice.id"
                                        ...
                                        <div>
                                            ...
                                            <select wire:model.live="characterBible.characters.{{ $editIndex }}.voice.gender"
                                                    style="width: 100%; padding: 0.25rem 0.35rem; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 0.25rem; color: white; font-size: 0.6rem;">
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.3rem; margin-bottom: 0.3rem;">
                                        ...
                                        <div>
                                            ...
                                            <select wire:model.live="characterBible.characters.{{ $editIndex }}.voice.style"
                                                    style="width: 100%; padding: 0.25rem 0.35rem; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 0.25rem; color: white; font-size: 0.6rem;">
                                        ...
                                        <div>
                                            ...
                                            <select wire:model.live="characterBible.characters.{{ $editIndex }}.voice.pitch"
                                                    style="width: 100%; padding: 0.25rem 0.35rem; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 0.25rem; color: white; font-size: 0.6rem;">
                                    ...
                                    <div style="margin-bottom: 0.35rem;">
                                        ...
                                        <input type="range"
                                               wire:model.change="characterBible.characters.{{ $editIndex }}.voice.speed"
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr auto; gap: 0.5rem; padding-top: 0.3rem; border-top: 1px solid rgba(255,255,255,0.1);">
                                        ...
                                        <div>
                                            ...
                                            <select wire:model.live="characterBible.characters.{{ $editIndex }}.speakingRole"
                                                    style="width: 100%; padding: 0.25rem 0.35rem; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-radius: 0.25rem; color: white; font-size: 0.6rem;">
                                        ...
                                        <div style="display: flex; flex-direction: column; align-items: center; justify-content: flex-end;">
                                            <label style="display: flex; align-items: center; gap: 0.3rem; cursor: pointer; padding: 0.25rem 0.4rem; background: {{ ($currentChar['isNarrator'] ?? false) ? 'rgba(251,191,36,0.25)' : 'rgba(255,255,255,0.05)' }}; border: 1px solid {{ ($currentChar['isNarrator'] ?? false) ? 'rgba(251,191,36,0.5)' : 'rgba(255,255,255,0.15)' }}; border-radius: 0.25rem;">
                                                <input type="checkbox"
                                                       wire:model.live="characterBible.characters.{{ $editIndex }}.isNarrator"
                    ...
                    <div style="margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid rgba(255,255,255,0.1);">
                        ...
                        @if($appliedCount === 0 && $totalScenes > 0)
                            <div style="padding: 0.35rem 0.5rem; margin-bottom: 0.3rem; background: rgba(239, 68, 68, 0.15); border: 1px solid rgba(239, 68, 68, 0.3); border-radius: 0.25rem;">
                                <span style="color: #fca5a5; font-size: 0.55rem;">{{ __('Please assign at least one scene to this character') }}</span>
                            </div>
                        @endif
                        <div style="display: flex; flex-wrap: wrap; gap: 0.25rem;">
                            @foreach($scriptScenes ?? [] as $sceneIndex => $scene)
                                @php
        ...
        <div style="padding: 0.5rem 1rem; border-top: 1px solid rgba(255,255,255,0.1); display: flex; justify-content: space-between; align-items: center; flex-shrink: 0;">
            <label style="display: flex; align-items: center; gap: 0.4rem; color: rgba(255,255,255,0.7); font-size: 0.7rem; cursor: pointer;">
                <input type="checkbox" wire:model.live="characterBible.enabled" style="accent-color: #8b5cf6;">
